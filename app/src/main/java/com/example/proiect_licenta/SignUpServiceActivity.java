...
//                    "(?=.*[@#$%^&+=])" +    //at least 1 special character
    ...
    public void getServiceInfo(String username, String email, String pass, String telefon){
        ...
        if(serviceNou!=null) {
            Toast.makeText(SignUpServiceActivity.this, "Info service 1: " + serviceNou.username + " " + serviceNou.email + " " + serviceNou.telefon + " " + serviceNou.pass, Toast.LENGTH_LONG).show();
            goToServiceProfile();
        }
    }
